...
REM
REM Generated by Vivado on Wed Mar 25 22:19:38 +0100 2026
...
echo "xvhdl --incr --relax -prj tb_dual_stepper_vhdl.prj"
call xvhdl  --incr --relax -prj tb_dual_stepper_vhdl.prj -log xvhdl.log
