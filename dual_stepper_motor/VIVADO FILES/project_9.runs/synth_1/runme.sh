...
HD_PWD='C:/Users/robin/Documents/GitHub/FPGA-GearBox---Group-Bertolini-Liberato/dual_stepper_motor/VIVADO FILES/project_9.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dual_stepper_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dual_stepper_top.tcl
