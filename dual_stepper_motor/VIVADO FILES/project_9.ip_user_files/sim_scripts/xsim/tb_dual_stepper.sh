...
#
# Script generated by Vivado on Tue Apr 14 10:13:51 +0200 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : tb_dual_stepper.sh
...
#
# Usage        : tb_dual_stepper.sh
#                tb_dual_stepper.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tb_dual_stepper.sh [-rerun]
#                tb_dual_stepper.sh [-reset_run]
#                tb_dual_stepper.sh [-clean]
#                tb_dual_stepper.sh [-reset_log]
#                tb_dual_stepper.sh [-help]
#
...
# script info
echo -e "tb_dual_stepper.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tb_dual_stepper.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot tb_dual_stepper xil_defaultlib.tb_dual_stepper xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim tb_dual_stepper -key {Behavioral:sim_1:Functional:tb_dual_stepper} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb tb_dual_stepper.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tb_dual_stepper.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tb_dual_stepper.sh [-help]\n\
Usage: tb_dual_stepper.sh [-step]\n\
Usage: tb_dual_stepper.sh [-lib_map_path]\n\
Usage: tb_dual_stepper.sh [-rerun]\n\
Usage: tb_dual_stepper.sh [-reset_run]\n\
Usage: tb_dual_stepper.sh [-clean]\n\
Usage: tb_dual_stepper.sh [-reset_log]\n\
Usage: tb_dual_stepper.sh [-keep_index]\n\
Usage: tb_dual_stepper.sh [-noclean_files]\n\n\
