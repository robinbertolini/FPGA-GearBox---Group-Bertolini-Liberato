...
REM
REM Generated by Vivado on Tue Jun 02 19:32:40 +0200 2026
...
echo "xvhdl --incr --relax -prj tb_main_motor_top_pwm_vhdl.prj"
call xvhdl  --incr --relax -prj tb_main_motor_top_pwm_vhdl.prj -log xvhdl.log
