...
REM
REM Generated by Vivado on Wed May 27 10:52:48 +0200 2026
...
echo "xvhdl --incr --relax -prj main_motor_top_pwm_tb_vhdl.prj"
call xvhdl  --incr --relax -prj main_motor_top_pwm_tb_vhdl.prj -log xvhdl.log
